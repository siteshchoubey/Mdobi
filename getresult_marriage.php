...
$paginationlink = "getresult_marriage.php?page=";
...
<form name="frmSearch" method="post" action="marriage.php">
		...
		<div class="row">
			...
			<div class="col-lg-12">
			  ...
			  <div class="sub_heading">
			    ...
			    <samp>"Marriage, spouse, long-term commitment, wed, tie-the-knot, nuptials, matrimony"</samp>
