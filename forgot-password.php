...
$body  = 'Your Password is : '.$pass;
 ...
 if($sentmail)
 {
  $msg =  "<div class='alert alert-danger'>Your password is send</div>";
 }
 else{
  $msg =  "<div class='alert alert-danger'>Something worong</div>";
 }
                          ...
                          <!--   <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                    	<input type="submit" name="forgot-pass" value="Forgot Password" class="btn btn-success"/>
