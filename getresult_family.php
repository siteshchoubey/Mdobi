...
$paginationlink = "getresult_family.php?page=";
...
<form name="frmSearch" method="post" action="family.php">
		...
		<div class="row">
			...
			<div class="col-lg-12">
			  ...
			  <div class="sub_heading">
			    ...
			    <samp>"Family, children, ancestors, offspring, kin, parenting, descendant, heir, birth, baby"</samp>
